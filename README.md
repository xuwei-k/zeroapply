...
```scala
libraryDependencies += "com.github.xuwei-k" %% "zeroapply" % "0.2.0-M1"
```

```scala
libraryDependencies += "com.github.xuwei-k" %% "zeroapply-scalaz" % "0.2.0-M1"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.0-M1/zeroapply-all_2.11-0.2.0-M1-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.0-M1/zeroapply-all_2.11-0.2.0-M1-sxr.jar/!/index.html)
