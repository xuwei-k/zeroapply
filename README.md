...
```scala
libraryDependencies += "com.github.xuwei-k" %% "zeroapply" % "0.2.0"
```

```scala
libraryDependencies += "com.github.xuwei-k" %% "zeroapply-scalaz" % "0.2.0"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.0/zeroapply-all_2.11-0.2.0-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.0/zeroapply-all_2.11-0.2.0-sxr.jar/!/index.html)
...
libraryDependencies += "com.github.xuwei-k" %% "zeroapply" % "0.2.1-SNAPSHOT"
```

```scala
resolvers += Opts.resolver.sonatypeSnapshots

libraryDependencies += "com.github.xuwei-k" %% "zeroapply-scalaz" % "0.2.1-SNAPSHOT"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.1-SNAPSHOT/zeroapply-all_2.11-0.2.1-SNAPSHOT-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/zeroapply-all_2.11/0.2.1-SNAPSHOT/zeroapply-all_2.11-0.2.1-SNAPSHOT-sxr.jar/!/index.html)
